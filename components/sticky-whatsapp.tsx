    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="group fixed bottom-5 left-5 z-40 hidden items-center gap-0 overflow-hidden border border-line-strong bg-background/90 px-4 py-3 backdrop-blur-xl transition-colors duration-500 hover:border-gold md:bottom-8 md:left-8 md:flex"
        >
