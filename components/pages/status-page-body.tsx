      ...
      <div className="section-gutter relative pt-32 pb-24 md:pt-40 md:pb-32">
        ...
        {action && (
          <button
            ...
            className="group from-gold-soft to-gold relative mt-10 inline-flex items-center gap-2.5 overflow-hidden bg-gradient-to-br px-7 py-3.5 text-sm tracking-wide text-[#201e1b]"
          >
            <span
              aria-hidden="true"
