...
// Radius folgt dem Haus-System (--radius = 2px), nicht dem shadcn-Default
// (6px). Sechs Pixel Rundung neben durchgehend scharfen Hairline-Karten
// sahen aus wie ein Fremdkoerper.
