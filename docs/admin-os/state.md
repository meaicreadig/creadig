...
| 24.09.2026 | 7 | **Migration 020 angewendet.** Sicherung + Rückspielprobe 12/12 · 020 (`publications`) · Nachprüfung grün · Register live geprüft (anlegen, Reaktion, Neuladen, DE/TR, mobil) · Cutover-Probe aus den operativen Zahlen genommen (`zz cutover-probe` in `TEST_PREFIXES`) → 0 offene Chancen, 0 neue Anfragen. G18 aufgelöst (KEEP). |
