...
| ADM-06 | 🟡 | 🔴 | 🔴 | 🔴 | `IN_PROGRESS` — Automation + meAI lokal VERIFIED, Analytics (A25) offen | ADM-06/3 Analytics; Cutover mit Migration 019 im selben Paket wie 015–018 | meAI-**Anbieter/Kosten = Owner** (A8·8) — blockiert 99 % **nicht**: A30 besteht im Degraded Mode |
...
**Fortsetzungspunkt:** ADM-06/3 Analytics (A25 Chart-Drilldown), danach ADM-07 (A01–A32 + B01–B12 Gesamtlauf). Migrationen 015–019 weiter **nicht** freigegeben. meAI-Anbieter/Kosten = Owner (optional, blockiert nicht). Production-Tip nicht promoten ohne Cutover-Paket.
