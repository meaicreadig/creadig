...
npx tsc --noEmit
npx eslint .
npm run build           → Function · Sterne · Parität · Bestand · Freigabe · Auftritt · Redaktion · Herkunft · Angebot · Lieferung · Produkt · Verkauf · Rollen · Betrieb · Kundenerfolg · Wirtschaft · Gedächtnis · Navigator
