...
export const rechnerText = {
  ...
  felder: {
    ...
    investition: {
      ...
      hilfe: {
        de: "Optional. Eine Zahl, die Sie selbst setzen — für Systemprojekte nennen wir den Festpreis erst nach dem Systemgespräch.",
        tr: "İsteğe bağlı. Kendi koyduğunuz bir rakam — sistem projelerinde sabit fiyatı sistem görüşmesinden sonra söylüyoruz.",
        en: "Optional. A number you set yourself — for system projects we name the fixed price only after the system call.",
        ar: "اختياري. رقم تضعونه أنتم — لمشاريع الأنظمة نذكر السعر الثابت بعد محادثة النظام فقط.",
      },
