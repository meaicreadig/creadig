...
export type InsightBlock =
  ...
  | { kind: "list"; items: { de: string[]; tr: string[] } }
...
export const insights: Insight[] = [
  {
    ...
    body: [
      ...
      { kind: "heading", text: { de: "Was geprüft wurde", tr: "Ne denetlendi" } },
      {
        kind: "text",
        text: {
      ...
      {
        kind: "heading",
        text: { de: "1 · Der Fokus war unsichtbar", tr: "1 · Odak görünmüyordu" },
      },
      {
        kind: "text",
        text: {
      ...
      {
        kind: "heading",
        text: { de: "2 · Acht Stationen bis zum Inhalt", tr: "2 · İçeriğe kadar sekiz durak" },
      },
      {
        kind: "text",
        text: {
      ...
      { kind: "heading", text: { de: "Die übrigen fünf", tr: "Kalan beşi" } },
      {
        kind: "list",
        items: {
          de: [
      ...
      {
        kind: "heading",
        text: { de: "Der schwerste Fehler war älter", tr: "En ağır hata daha eskiydi" },
      },
      {
        kind: "text",
        text: {
      ...
      {
        kind: "heading",
        text: { de: "Und ein Messfehler", tr: "Ve bir ölçüm hatası" },
      },
      {
        kind: "text",
        text: {
      ...
      {
        kind: "heading",
        text: { de: "Was das heißt — und was nicht", tr: "Bu ne demek — ve ne demek değil" },
      },
      {
        kind: "text",
        text: {
