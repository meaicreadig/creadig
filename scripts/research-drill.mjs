...
console.log("\nJ9 · Mehrfachbeleg wird sichtbar, nicht aufgeloest")
...
const w = R.mehrfachBelegt(s9)
p(w.length === 1 && w[0].belege.length === 2, "zwei gueltige Belege zum selben Signal gemeldet", `${w[0]?.ref}`)
...
p(R.mehrfachBelegt(s9).length === 0, "nach bewusster Entscheidung geloest")
